  ...
  return (
    <div className='flex flex-row gap-5 lg:w-[75vw] md:w-[80vw] mx-auto'>
      <div className="flex flex-col gap-10 p-12 w-[80%]">
        <div>
          <h1 className="font-bold text-5xl">ART OF HOOKAH</h1>
          <h1 className="font-bold text-4xl">PREMIUM FLAVORS.</h1>
          ...
          <div className="flex gap-5">
            <button className='border border-white bg-white text-black p-3 px-6'>Shop Hookahs</button>
            <button className='border border-gray-300 p-3 px-6'>Browse Flavours</button>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-8 items-center justify-center">
        ...
        <div className="flex gap-8 w-full items-center justify-center">
          <p className="p-12 w-[50%] bg-[#131313] text-center rounded-full">Enjoy curated hookah experiences that highlight your taste and presence.</p>
          <p className="p-12 w-[50%] bg-[#131313] text-center rounded-full">Relax, connect, and savor every moment with our premium selection.</p>
        </div>
      </div>
    </div>
  )
